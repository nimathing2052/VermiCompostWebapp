...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["polyfills-es5"], {
        ...
        function node_modulesCoreJsInternalsArrayFromJs(module, exports, __webpack_require__) {
            ...
            /* , mapfn = undefined, thisArg = undefined */
                ...
                if (mapping)
                    mapfn = bind(mapfn, argumentsLength > 2 ? arguments[2] : undefined, 2); // if the target is not iterable or it's an array with the default iterator - use a simple case
            ...
            module.exports = {
                getConstructor: function getConstructor(wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
                    ...
                    var getEntry = function getEntry(that, key) {
                        ...
                        var entry;
                        if (index !== 'F')
                            return state.index[index]; // frozen object case
        ...
        function node_modulesCoreJsInternalsInternalMetadataJs(module, exports, __webpack_require__) {
            ...
            var getWeakData = function getWeakData(it, create) {
                if (!has(it, METADATA)) {
                    ...
                    if (!create)
                        return false; // add missing metadata
        ...
        function node_modulesCoreJsInternalsRedefineJs(module, exports, __webpack_require__) {
            ...
            (module.exports = function (O, key, value, options) {
                ...
                if (simple)
                    ...
                    createNonEnumerableProperty(O, key, value); // add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
        ...
        function node_modulesCoreJsModulesEsPromiseJs(module, exports, __webpack_require__) {
            ...
            var FORCED = isForced(PROMISE, function () {
                ...
                if (!GLOBAL_CORE_JS_PROMISE) {
                    ...
                    if (V8_VERSION === 66)
                        return true; // Unhandled rejections tracking support, NodeJS Promise without it fails @@species test
                    if (!IS_NODE && typeof PromiseRejectionEvent != 'function')
                        return true;
                } // We need Promise#finally in the pure version for preventing prototype pollution
                if (IS_PURE && !PromiseConstructor.prototype['finally'])
                    return true; // We can't use @@species feature detection in V8 since it causes
                ...
                if ('abbc'.split(/(b)*/)[1] == 'c' || 'test'.split(/(?:)/, -1).length != 4 || 'ab'.split(/(?:ab)*/).length != 2 || '.'.split(/(.?)(.?)/).length != 4 || '.'.split(/()()/).length > 1 || ''.split(/.?/).length) {
                    ...
                    internalSplit = function internalSplit(separator, limit) {
                        ...
                        if (separator === undefined)
                            return [string]; // If `separator` is not a regex, use native split
            ...
            */
            (function (factory) {
                ...
                function patchClass(className) {
                    ...
                    if (!OriginalClass)
                        return; // keep original class in global
                ...
                function patchCustomElements(_global, api) {
                    var _api$getGlobalObjects = api.getGlobalObjects(), isBrowser = _api$getGlobalObjects.isBrowser, isMix = _api$getGlobalObjects.isMix;
                ...
                function eventTargetPatch(_global, api) {
                    ...
                    var _api$getGlobalObjects2 = api.getGlobalObjects(), eventNames = _api$getGlobalObjects2.eventNames, zoneSymbolEventNames = _api$getGlobalObjects2.zoneSymbolEventNames, TRUE_STR = _api$getGlobalObjects2.TRUE_STR, FALSE_STR = _api$getGlobalObjects2.FALSE_STR, ZONE_SYMBOL_PREFIX = _api$getGlobalObjects2.ZONE_SYMBOL_PREFIX; //  predefine all __zone_symbol__ + eventName + true/false string
            ...
            (function (factory) {
                ...
                function canPatchViaPropertyDescriptor(api, _global) {
                    ...
                    if ((isBrowser || isMix) && !api.ObjectGetOwnPropertyDescriptor(HTMLElement.prototype, 'onclick') && typeof Element !== 'undefined') {
                        ...
                        if (desc && !desc.configurable)
                            return false; // try to use onclick to detect whether we can patch via propertyDescriptor
        ...
        function _(module, exports, __webpack_require__) {
            ...
            /*! C:\Users\i25690\MVC-WebApp\NepaliTreat\NepaliTreat\ClientApp\polyfills.ts */
            "./ClientApp/polyfills.ts");
            /***/
        }
    }, [[1, "runtime"]]]);
